...
setuptools.setup(
    ...
    package_data={"stretch_urdf": ["RE2V0/meshes/*.STL","RE2V0/meshes/*.dae","RE2V0/xacro/*.xacro","RE2V0/xacro/d435i/*.xacro","RE2V0/*.urdf",
                                   "RE1V0/meshes/*.STL","RE1V0/meshes/*.dae","RE1V0/xacro/*.xacro","RE1V0/xacro/d435i/*.xacro","RE1V0/*.urdf",
                                   "SE3/meshes/*.STL","SE3/meshes/*.dae","SE3/xacro/*.xacro","SE3/xacro/d435i/*.xacro","SE3/*.urdf"]},
